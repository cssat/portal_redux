CREATE PROCEDURE [portal_redux].[sp_ia_trends_rates] (
	@date VARCHAR(3000)
...
AS
EXEC portal_redux.log_query_ia_trends @age_sib_group_cd
	,@cd_race_census
	,@cd_county
	,@cd_reporter_type
	,@cd_access_type
...
FROM portal_redux.fn_ReturnStrTableFromList(@age_sib_group_cd, 0)
...
FROM portal_redux.ia_trends_cache m
