...
-- DROP TABLE portal_redux.prtl_poc1ab_entries;
...
-- populate prtl_poc1ab_entries table
-- also contains exits, remove later

-- DROP PROCEDURE portal_redux.prod_build_prtl_poc1ab_entries_exits
CREATE procedure  portal_redux.prod_build_prtl_poc1ab_entries_exits
as 
  set nocount on
begin
...
----  UNIQUE DCFS exits  (maybe remove)
				union all
