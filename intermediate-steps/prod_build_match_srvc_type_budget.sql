-- create ref_match_srvc_type_budget table
...
CREATE TABLE portal_redux.ref_match_srvc_type_budget (
	...
	CONSTRAINT PK__ref_matc__61010EBDBA2677B7 PRIMARY KEY (filter_service_budget,cd_budget_poc_frc)
);


-- populate ref_match_srvc_type_budget table
