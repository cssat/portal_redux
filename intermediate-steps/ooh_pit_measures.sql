DROP TABLE IF EXISTS portal_redux.ooh_pit_measures;
CREATE TABLE [portal_redux].[ooh_pit_measures] (
...
CREATE NONCLUSTERED INDEX [idx_ooh_pit_measures_pit] ON [portal_redux].[ooh_pit_measures] (
	[fl_ooh_pit]
...
CREATE NONCLUSTERED INDEX [idx_ooh_pit_measures_fl_ooh_pit] ON [portal_redux].[ooh_pit_measures] (
	[county_cd]
	,[cd_reporter_type]
	,[fl_ooh_pit]
	) INCLUDE (
...
CREATE NONCLUSTERED INDEX [idx_ooh_pit_measures_wb_family_settings] ON [portal_redux].[ooh_pit_measures] (
	[county_cd]
...
CREATE NONCLUSTERED INDEX [idx_ooh_pit_measures_wb_family_settings_2] ON [portal_redux].[ooh_pit_measures] (
	[age_grouping_cd_mix]
	,[fl_ooh_wb_family_settings]
	) INCLUDE (
	[qry_type]
...
CREATE NONCLUSTERED INDEX [idx_ooh_pit_measures_wb_siblings] ON [portal_redux].[ooh_pit_measures] (
	[county_cd]
	,[fl_ooh_wb_siblings]
	) INCLUDE (
	[qry_type]
...
CREATE NONCLUSTERED INDEX [idx_ooh_pit_measures_wb_siblings_2] ON [portal_redux].[ooh_pit_measures] (
	[fl_ooh_wb_siblings]
	) INCLUDE (
	[qry_type]
	,[date_type]
