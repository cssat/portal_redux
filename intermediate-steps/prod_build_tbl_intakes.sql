...
CREATE NONCLUSTERED INDEX idx_cd_final_decision
    ON portal_redux.tbl_intakes(cd_final_decision ASC)
...
CREATE NONCLUSTERED INDEX idx_tbl_intakes_filters
    ON portal_redux.tbl_intakes(id_intake_fact ASC)
