-- create rate_referrals_scrn_in_order_specific table

DROP TABLE IF EXISTS portal_redux.rate_referrals_scrn_in_order_specific;
CREATE TABLE portal_redux.rate_referrals_scrn_in_order_specific (
