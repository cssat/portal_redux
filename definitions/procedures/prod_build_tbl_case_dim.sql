-- prod_build_tbl_case_dim definition

-- EXEC portal_redux.prod_build_tbl_case_dim;
-- DROP TABLE IF EXISTS portal_redux.prod_build_tbl_case_dim;
...
BEGIN
	...
	SET @EndDate = (select cutoff_date from portal_redux.ref_last_dw_transfer)
