-- prod_update_tbl_intakes_after_ihs definition

-- EXEC portal_redux.prod_update_tbl_intakes_after_ihs;
-- DROP PROCEDURE IF EXISTS portal_redux.prod_update_tbl_intakes_after_ihs;
CREATE PROCEDURE portal_redux.prod_update_tbl_intakes_after_ihs
AS
