-- prod_build_ooh_point_in_time_child definition

-- EXEC portal_redux.prod_build_ooh_point_in_time_child;
-- DROP PROCEDURE IF EXISTS portal_redux.prod_build_ooh_point_in_time_child;
CREATE PROCEDURE portal_redux.prod_build_ooh_point_in_time_child
AS
