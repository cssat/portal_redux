-- prod_build_rate_placement definition

-- EXEC portal_redux.prod_build_rate_placement;
-- DROP PROCEDURE IF EXISTS portal_redux.prod_build_rate_placement;
CREATE PROCEDURE portal_redux.prod_build_rate_placement
AS
