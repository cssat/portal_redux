-- prod_build_rate_referrals_order_specific definition

-- EXEC portal_redux.prod_build_rate_referrals_order_specific;
-- DROP PROCEDURE IF EXISTS portal_redux.prod_build_rate_referrals_order_specific;
CREATE PROCEDURE portal_redux.prod_build_rate_referrals_order_specific
AS
