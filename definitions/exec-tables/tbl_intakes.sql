...
CREATE TABLE CA_ODS.base.tbl_intakes (
	id_intake_fact int NOT NULL,
	id_case int NOT NULL,
	id_investigation_assessment_fact int NULL,
	id_safety_assessment_fact int NULL,
 ...
 CREATE NONCLUSTERED INDEX idx_783ld4kg ON base.tbl_intakes (  cd_final_decision ASC  )  
	 ...
	 ON [PRIMARY ] ;
 CREATE NONCLUSTERED INDEX idx_cd_final_decision ON base.tbl_intakes (  cd_final_decision ASC  )  
	 ...
	 WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	 ON [PRIMARY ] ;
 CREATE NONCLUSTERED INDEX idx_cps_874 ON base.tbl_intakes (  fl_cps_invs ASC  )  
	 INCLUDE ( id_investigation_assessment_fact , inv_ass_stop ) 
	 WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	 ON [PRIMARY ] ;
 CREATE NONCLUSTERED INDEX idx_dafsdf ON base.tbl_intakes (  id_access_report ASC  )  
	 WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	 ON [PRIMARY ] ;
 CREATE NONCLUSTERED INDEX idx_final_decision ON base.tbl_intakes (  cd_final_decision ASC  )  
	 ...
	 WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	 ON [PRIMARY ] ;
 CREATE NONCLUSTERED INDEX idx_final_decision_incl_intk_alg_fnd ON base.tbl_intakes (  cd_final_decision ASC  )  
	 ...
	 WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	 ON [PRIMARY ] ;
 CREATE NONCLUSTERED INDEX idx_tbl_intakes ON base.tbl_intakes (  fl_reopen_case ASC  )  
	 INCLUDE ( cd_access_type , cd_final_decision , fl_cps_invs , inv_ass_start ) 
	 WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	 ON [PRIMARY ] ;
 CREATE NONCLUSTERED INDEX idx_tbl_intakes_filters ON base.tbl_intakes (  id_intake_fact ASC  )  
