...
CREATE NONCLUSTERED INDEX NonClusteredIndex_20140326_102159 ON portal_redux.LEGAL_FACT (  ID_LEGAL_ACTION_DIM ASC  , ID_LEGAL_RESULT_DIM ASC  , ID_LEGAL_STATUS_DIM ASC  )  
	INCLUDE ( ID_CALENDAR_DIM_EFFECTIVE , ID_CALENDAR_DIM_HEARING ) 
	WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	ON [PRIMARY];
CREATE NONCLUSTERED INDEX idx_id_legal_result_dim ON portal_redux.LEGAL_FACT (  ID_LEGAL_RESULT_DIM ASC  )  
	INCLUDE ( ID_CALENDAR_DIM_EFFECTIVE , ID_LEGAL_ACTION_DIM , ID_LEGAL_STATUS_DIM , ID_PRSN ) 
	WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	ON [PRIMARY];
CREATE NONCLUSTERED INDEX idx_id_prsn_legal_fact_incl_eff_hearing_status ON portal_redux.LEGAL_FACT (  ID_PRSN ASC  )  
	INCLUDE ( ID_CALENDAR_DIM_EFFECTIVE , ID_CALENDAR_DIM_HEARING , ID_LEGAL_STATUS_DIM ) 
	WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	ON [PRIMARY];
CREATE NONCLUSTERED INDEX idx_legal_fact_ID_LEGAL_RESULT_DIM_INCL ON portal_redux.LEGAL_FACT (  ID_LEGAL_RESULT_DIM ASC  )  
	INCLUDE ( ID_CALENDAR_DIM_EFFECTIVE , ID_CALENDAR_DIM_HEARING , ID_CASE , ID_LEGAL_ACTION_DIM , ID_LEGAL_STATUS_DIM , ID_PRSN ) 
	WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	ON [PRIMARY];
CREATE NONCLUSTERED INDEX idx_legal_fact_id_legal_result_dim ON portal_redux.LEGAL_FACT (  ID_LEGAL_RESULT_DIM ASC  )  
