-- create prtl.cache_ooh_params_backup table

-- DROP TABLE portal_redux.cache_ooh_params_backup;
CREATE TABLE portal_redux.cache_ooh_params_backup (
	...
	bin_dep_cd varchar(20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
