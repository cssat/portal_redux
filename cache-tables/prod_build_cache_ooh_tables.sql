-- create prod_build_cache_ooh_tables stored procedure

-- DROP PROCEDURE portal_redux.prod_build_cache_ooh_tables;
...
begin
 ...
 +  ')' + char(13) + char(10) --
					...
					set @mysql=@mysql +'where tbl_id='  +   ((select convert(varchar(2),xwlk.tbl_id)  from portal_redux.prtl_tables_last_update  tbl join prtl.tbl_procedure_xwalk xwlk on tbl.tbl_id=xwlk.tbl_id where procedure_id=@procedure_id and tbl_seq_nbr=@loop ))  + char(13) + char(10) --
