-- prod_build_prtl_outcomes definition

-- EXEC portal_redux.prod_build_prtl_outcomes;
-- DROP PROCEDURE IF EXISTS portal_redux.prod_build_prtl_outcomes;
CREATE PROCEDURE portal_redux.prod_build_prtl_outcomes
AS
