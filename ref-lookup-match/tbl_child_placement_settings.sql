-- create tbl_child_placement_settings view

--DROP VIEW IF EXISTS portal_redux.tbl_child_placement_settings;
CREATE VIEW portal_redux.tbl_child_placement_settings
AS
SELECT
	...
	LEFT JOIN (
		...
		WHERE 
			NOT EXISTS (
				SELECT
					*
				FROM portal_redux.rptPlacement_Events PEI
				WHERE
