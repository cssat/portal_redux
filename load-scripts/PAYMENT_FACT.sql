...
CREATE NONCLUSTERED INDEX idx_am_total_paid ON portal_redux.PAYMENT_FACT (  AM_TOTAL_PAID ASC  )  
	...
	ON [PRIMARY];
CREATE NONCLUSTERED INDEX idx_payment_fact_am_total_paid_incl7 ON portal_redux.PAYMENT_FACT (  AM_TOTAL_PAID ASC  )  
	...
	WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	ON [PRIMARY];
CREATE NONCLUSTERED INDEX idx_payment_fact_prov_svc_prsn_paid_incl3 ON portal_redux.PAYMENT_FACT (  ID_PROVIDER_DIM_SERVICE ASC  , ID_SERVICE_TYPE_DIM ASC  , ID_PRSN_CHILD ASC  , AM_TOTAL_PAID ASC  )  
	INCLUDE ( ID_CALENDAR_DIM_SERVICE_BEGIN , ID_CALENDAR_DIM_SERVICE_END , ID_PAYMENT_FACT ) 
	WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	ON [PRIMARY];
CREATE NONCLUSTERED INDEX idx_provider_srvc_child_incl_srvc_dates ON portal_redux.PAYMENT_FACT (  ID_PROVIDER_DIM_SERVICE ASC  , ID_PRSN_CHILD ASC  )  
	...
	WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	ON [PRIMARY];
CREATE NONCLUSTERED INDEX idx_std_id_prsn_child_payment_fact ON portal_redux.PAYMENT_FACT (  ID_SERVICE_TYPE_DIM ASC  )  
