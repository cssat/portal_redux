...
-- DROP TABLE portal_redux.cache_poc2ab_aggr;
...
-- populate cache_poc2ab_aggr table

-- DROP PROCEDURE portal_redux.prod_build_cache_poc2ab_aggr;	
CREATE procedure portal_redux.prod_build_cache_poc2ab_aggr (@permission_key datetime)
as
