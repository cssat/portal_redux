...
CREATE NONCLUSTERED INDEX NonClusteredIndex-20140603-133409 ON dbo.ASSIGNMENT_FACT (  ID_CALENDAR_DIM_BEGIN ASC  , ID_CASE ASC  )  
	WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	ON [PRIMARY];
CREATE NONCLUSTERED INDEX idx_asf_case_worker_begin_inc_fact_dim_end ON dbo.ASSIGNMENT_FACT (  ID_WORKER_DIM ASC  , ID_CASE ASC  , ID_CALENDAR_DIM_BEGIN ASC  )  
	INCLUDE ( ID_ASSIGNMENT_ATTRIBUTE_DIM , ID_ASSIGNMENT_FACT , ID_CALENDAR_DIM_END ) 
	WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	ON [PRIMARY];
CREATE NONCLUSTERED INDEX idx_id_case_id_calendar_dim_begin_aad ON dbo.ASSIGNMENT_FACT (  ID_CASE ASC  )  
	INCLUDE ( ID_ASSIGNMENT_ATTRIBUTE_DIM , ID_ASSIGNMENT_FACT , ID_CALENDAR_DIM_BEGIN ) 
	WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	ON [PRIMARY];
CREATE NONCLUSTERED INDEX idx_workder_dim_id_prsn_id_calendar_dim_begin ON dbo.ASSIGNMENT_FACT (  ID_PRSN ASC  )  
