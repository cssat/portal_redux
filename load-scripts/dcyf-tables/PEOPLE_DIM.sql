...
CREATE NONCLUSTERED INDEX idx_dt_birth ON dbo.PEOPLE_DIM (  DT_BIRTH ASC  )  
	INCLUDE ( CD_MRTL_STAT , ID_PRSN , TX_MRTL_STAT ) 
	WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	ON [PRIMARY];
CREATE NONCLUSTERED INDEX idx_id_people_dim_dad ON dbo.PEOPLE_DIM (  ID_PEOPLE_DIM_DAD ASC  )  
	INCLUDE ( ID_PEOPLE_DIM , ID_PRSN , ID_PRSN_DAD ) 
	WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	ON [PRIMARY];
CREATE NONCLUSTERED INDEX idx_id_people_dim_mom ON dbo.PEOPLE_DIM (  ID_PEOPLE_DIM_MOM ASC  )  
	INCLUDE ( ID_PEOPLE_DIM , ID_PRSN , ID_PRSN_MOM ) 
	WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	ON [PRIMARY];
CREATE NONCLUSTERED INDEX idx_id_prsn ON dbo.PEOPLE_DIM (  ID_PRSN ASC  , CD_GNDR ASC  , IS_CURRENT ASC  )  
	WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	ON [PRIMARY];
