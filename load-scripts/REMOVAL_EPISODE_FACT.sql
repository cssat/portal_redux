...
CREATE TABLE portal_redux.REMOVAL_EPISODE_FACT (
	...
	CONSTRAINT fk_REMOVAL_EPISODE_FACT_ID_DISCHARGE_REASON_DIM FOREIGN KEY (ID_DISCHARGE_REASON_DIM) REFERENCES portal_redux.DISCHARGE_REASON_DIM(ID_DISCHARGE_REASON_DIM),
	CONSTRAINT fk_REMOVAL_EPISODE_FACT_ID_FAMILY_STRUCTURE_DIM FOREIGN KEY (ID_FAMILY_STRUCTURE_DIM) REFERENCES portal_redux.FAMILY_STRUCTURE_DIM(ID_FAMILY_STRUCTURE_DIM),
